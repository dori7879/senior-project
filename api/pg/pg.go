...
func FormatError(err error) error {
	...
	switch err.Error() {
	case "UNIQUE constraint failed: students_groups.group_id, students_groups.student_id":
		return api.Errorf(api.ECONFLICT, "Student_groups already exists.")
	case "UNIQUE constraint failed: teachers_groups.group_id, teachers_groups.student_id":
		return api.Errorf(api.ECONFLICT, "Teachers_groups already exists.")
	default:
		return err
	}
}
