    ...
    return(
        <div className="bg-purple-200 ">
            <footer className="text-gray-800 body-font">
                <div className="container px-24 py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-no-wrap flex-wrap flex-col">
                    <div className="w-32 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
                        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                            <img src="fav.ico" alt="app logo"/>
                            <span className="text-md ml-3 text-purple-900 font-bold">EasySubmit</span>
                        </a>
                        <p className="mt-1 text-xs text-gray-600 text-justify">A simple and robust system that makes the interactions as intuitive as possible.</p>
                    </div>
                ...
                <div className=" container mx-auto flex-wrap justify-center w-screen py-1 px-5 flex max-w-full  bg-purple-100">
