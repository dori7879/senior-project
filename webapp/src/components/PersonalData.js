...
const PersonalData = () => {
  ...
  const handleCreateGroup = () => {
    GroupService.createGroup(groupTitleInput.current.value).then(
      (response) => {
  ...
  return (
    <div>
      <div>
        ...
        <p className="text-purple-900">
          <strong>{t("profile:role", "Role:")} </strong>{" "}
          {isTeacher
            ? t("profile:teacher", "Teacher")
      ...
      {isTeacher ? (
        <div>
          ...
          <ul>
            ...
            {ownedGroups === 0 ? (
              <p>{t("profile:nogroups", "You have no owned groups")}</p>
            ) : null}
          </ul>
        </div>
      ) : null}
        ...
        <div>
          ...
          <ul>
            ...
            {sharedGroups.length === 0 ? (
              <p>{t("profile:nogroups", "You have no shared groups")}</p>
            ) : null}
          </ul>
        </div>
      ) : null}
