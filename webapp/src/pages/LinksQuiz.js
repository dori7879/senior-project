...
const Links = (props) => {
  ...
  const fullStudentLink = `https://radiant-inlet-12251.herokuapp.com/quizzes/submit/${props.location.state.studentLink}`;
  const fullTeacherLink = `https://radiant-inlet-12251.herokuapp.com/quizzes/list-submissions/${props.location.state.teacherLink}`;
