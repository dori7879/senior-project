...
const Links = (props) => {
  ...
  const fullStudentLink = `/quizzes/submit/${props.location.state.studentLink}`
  const fullTeacherLink = `/quizzes/list-submissions/${props.location.state.teacherLink}`
    ...
    <div>
      ...
      <div className='flex flex-col items-center min-h-screen px-4 py-2 bg-purple-100 justify-top sm:px-6 lg:px-8 '>
        <div className='flex flex-col items-center justify-center pb-4'>
          <div className='pt-4 text-xl font-bold text-purple-900'>{t('links:links', 'Links')}</div>
