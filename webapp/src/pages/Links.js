...
const Links = (props) => {
  ...
  const fullStudentLink = `https://radiant-inlet-12251.herokuapp.com/homeworks/submit/${props.location.state.studentLink}`;
  const fullTeacherLink = `https://radiant-inlet-12251.herokuapp.com/homeworks/list-submissions/${props.location.state.teacherLink}`;
