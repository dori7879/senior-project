...
const LinksAttendance = (props) => {
  ...
  const fullStudentLink = `https://radiant-inlet-12251.herokuapp.com/attendances/submit/${props.location.state.studentLink}`;
  const fullTeacherLink = `https://radiant-inlet-12251.herokuapp.com/attendances/list-submissions/${props.location.state.teacherLink}`;
